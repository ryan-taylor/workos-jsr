...
Deno.test("Security Error Handling", async (t) => {
  ...
  await t.step(
    "should throw descriptive MissingCredentialsError for missing API key",
    () => {
      setupStrategies();
  ...
  await t.step(
    "should throw descriptive MissingCredentialsError for missing HTTP auth credentials",
    () => {
      setupStrategies();
  ...
  await t.step(
    "should throw descriptive MissingCredentialsError for missing OAuth2 access token",
    () => {
      setupStrategies();
  ...
  await t.step(
    "should throw descriptive NoMatchingSecurityError for multi-scheme endpoints",
    () => {
      setupStrategies();
      ...
      assertEquals(
        error.message.includes("Available credentials: oauth2"),
        true,
      );
  ...
  await t.step(
    "should handle error gracefully when throwOnNoMatch is false",
    () => {
      setupStrategies();
  ...
  await t.step(
    "should throw SecurityStrategyNotRegisteredError for unregistered schemes",
    () => {
      setupStrategies();
