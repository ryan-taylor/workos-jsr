...
`,
    ...
    // Write test files
    console.log(
      `Writing test file without extensions to: ${testFileWithoutExtensions}`,
    );
    await Deno.writeTextFile(
      testFileWithoutExtensions,
      contentWithoutExtensions,
    );

    console.log(
      `Writing test file with extensions to: ${testFileWithExtensions}`,
    );
    ...
    console.log(
      `something.ts: ${await fileExists(somethingFile) ? "✅" : "❌"}`,
    );
    console.log(
      `otherThing.ts: ${await fileExists(otherThingFile) ? "✅" : "❌"}`,
    );
    console.log(
      `utils/things.ts: ${await fileExists(thingsFile) ? "✅" : "❌"}`,
    );
    ...
    console.log(
      `\nExtensions properly preserved: ${
        extensionsPreserved ? "✅ YES" : "❌ NO"
      }`,
    );
