          ...
          <div className="content-display">
            {isHydrated ? (
              <div className="after-hydration">
                <p>This content is displayed <strong>after</strong> hydration</p>
                <p>The Fresh islands architecture has successfully hydrated this component!</p>
              </div>
            ) : (
              <div className="before-hydration">
                <p>This content is displayed <strong>before</strong> hydration</p>
          ...
          {mismatchDetected && (
            <div className="mismatch-warning">
              ...
              <p className="explanation">
                In real applications, mismatches can cause UI flickering or unexpected behavior.
                Fresh handles these gracefully by applying client-side changes after hydration.
              </p>
            </div>
          )}
        </div>
