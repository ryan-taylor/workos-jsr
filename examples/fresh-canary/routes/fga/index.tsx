      ...
      <div class='mb-8'>
        ...
        <div class='bg-blue-50 border-l-4 border-blue-500 p-4 mb-6'>
          <p class='text-blue-700'>
            This page demonstrates the capabilities of WorkOS FGA, allowing you to create authorization models and test permission checks in
            real-time.
          </p>
        </div>
      </div>
        ...
        <div class='grid grid-cols-1 md:grid-cols-3 gap-6 mb-6'>
          <div class='bg-white p-5 rounded-lg shadow'>
            ...
            <p class='text-gray-600'>
              Fine-Grained Authorization (FGA) is a sophisticated permission system that allows you to define relationships between objects and users
              with precise control over who can access what.
            </p>
          </div>
          <div class='bg-white p-5 rounded-lg shadow'>
