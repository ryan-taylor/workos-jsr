...
export default function AccountPage({ data }: PageProps<AccountData>) {
  ...
  const getErrorMessage = (errorCode: string) => {
    switch(errorCode) {
      ...
      case "update_failed": return "Failed to update account information";
  ...
  const getSuccessMessage = (successCode: string) => {
    switch(successCode) {
      ...
      case "password_updated": return "Password updated successfully";
            ...
            {userProfile && (
              <div>
                ...
                {userProfile.updatedAt && (
                  <p><strong>Last Updated:</strong> {new Date(userProfile.updatedAt).toLocaleString()}</p>
                )}
              </div>
            )}
          </div>
