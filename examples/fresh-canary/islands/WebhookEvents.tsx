...
export default function WebhookEvents(
  { initialEvents = [] }: WebhookEventsProps,
) {
  // State
  ...
  const fetchEvents = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `/api/webhooks/listener?${params.toString()}`,
      );
        ...
        <div class="flex flex-wrap gap-4">
          <div class="flex-1 min-w-[200px]">
            ...
            <select
              ...
              onChange={(e) =>
                setSelectedEventType((e.target as HTMLSelectElement).value)}
            >
              ...
              ? (
                <tr>
                  <td colSpan={5} class="px-6 py-4 text-center text-gray-500">
                    No webhook events received yet. Send a webhook to get
                    started.
                  </td>
                </tr>
              )
                        ...
                        <td colSpan={5} class="px-6 py-4 bg-gray-50">
                          <div class="space-y-4">
                            ...
                            <div>
                              ...
                              <p class="mt-1 text-sm text-gray-500">
                                Webhooks can be configured in your WorkOS
                                Dashboard. Make sure to set the webhook URL to:
                              </p>
                              <code class="block mt-1 p-2 bg-gray-100 rounded text-sm font-mono">
                                {`${globalThis.location.origin}/api/webhooks/listener`}
                              </code>
                            </div>
                          </div>
                        </td>
