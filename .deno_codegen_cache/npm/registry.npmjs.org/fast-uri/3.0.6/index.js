...
function resolveComponents(base, relative, options, skipNormalization) {
  ...
  if (!options.tolerant && relative.scheme) {
    ...
    if (
      relative.userinfo !== undefined || relative.host !== undefined ||
      ...
      if (!relative.path) {
        ...
        if (relative.path.charAt(0) === "/") {
          ...
          if (
            (base.userinfo !== undefined || base.host !== undefined ||
...
function parse(uri, opts) {
  ...
  if (matches) {
    ...
    if (
      parsed.scheme === undefined && parsed.userinfo === undefined &&
      parsed.host === undefined && parsed.port === undefined &&
      parsed.query === undefined && !parsed.path
    ) {
    ...
    if (
      ...
      if (
        ...
        isIP === false && nonSimpleDomain(parsed.host)
      ) {
