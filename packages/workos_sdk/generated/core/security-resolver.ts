 ...
 */
export interface SecurityResolutionResult<S extends SupportedAuthScheme = SupportedAuthScheme> {
  /**
 ...
 */
export function resolveSecurityStrategy<S extends SupportedAuthScheme = SupportedAuthScheme>(
  ...
  const schemePriority = resolverOptions.schemePriority || DEFAULT_SCHEME_PRIORITY;
