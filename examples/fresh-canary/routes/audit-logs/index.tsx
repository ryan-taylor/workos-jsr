...
import { getMockAuditLogs, AuditLogEvent, getUniqueActionTypes, getUniqueActorNames } from "../../utils/audit-logs.ts";
...
const AuditLogsPage: FunctionComponent<PageProps<AuditLogsPageData>> = ({ data }) => {
    ...
    <div class="p-4 mx-auto max-w-screen-lg">
      <div class="mb-6">
        ...
        <p class="text-gray-700">
          Track and monitor security and administrative events in your application with WorkOS Audit Logs.
        </p>
      </div>
      ...
      <div class="mt-12 bg-white p-6 rounded-lg shadow">
        ...
        <p class="mb-4">
          Audit logs provide a chronological record of activities performed within your application, 
          helping you monitor user actions, system events, and security-related activities.
        </p>
        ...
        <ul class="list-disc pl-5 space-y-1">
          ...
          <li>Track events with detailed information about actors, targets, and context</li>
          <li>Export logs for compliance purposes or advanced analysis</li>
          <li>Build user interfaces to search and analyze activity</li>
          <li>Integrate with your security information and event management (SIEM) systems</li>
        </ul>
