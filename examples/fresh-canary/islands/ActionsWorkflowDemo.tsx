                        ...
                        <td class='px-6 py-4 whitespace-nowrap'>
                          <span
                            class={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full ${
                              action.type === 'authentication' ? 'bg-purple-100 text-purple-800' : 'bg-blue-100 text-blue-800'
                            }`}
                          >
                            ...
                            : (
                              <div>
                                <span class='text-xs text-gray-500'>
                                  {action.status.charAt(0).toUpperCase() + action.status.slice(1)} by {action.approver?.email || 'System'}
                                </span>
                                {action.reason && (
            ...
            <div class='flex-1 flex justify-between items-center'>
              <div>
                <p class='text-sm text-gray-700'>
                  ...
                  <span class='font-medium'>{Math.min(page * limit, total)}</span> of <span class='font-medium'>{total}</span> results
                </p>
              </div>
              <div>
