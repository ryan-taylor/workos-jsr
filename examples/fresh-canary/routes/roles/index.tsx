    ...
    <div class="p-4 mx-auto max-w-screen-lg">
      <div class="mb-8">
        ...
        <div class="bg-white p-6 rounded-lg shadow-sm mb-6">
          ...
          <p class="mb-4">
            Role-Based Access Control (RBAC) is a security approach that restricts system access to authorized users based on roles.
            Instead of assigning permissions directly to users, permissions are associated with roles, and users are assigned to appropriate roles.
          </p>
      ...
      <div class="mt-8 text-sm text-gray-600 p-4 bg-gray-50 rounded">
        ...
        <p>
          This demo showcases a UI implementation of WorkOS's Roles functionality with simulated data. 
          In a production environment, you would connect this interface to your actual WorkOS instance
          to manage and assign roles for your organization's users.
        </p>
      </div>
    </div>
  );
