  ...
  return (
    <div class='relationship-item bg-gray-50 p-3 rounded mb-2 border border-gray-200 flex justify-between items-center'>
      <div>
        ...
        {relationship.description && <p class='text-sm text-gray-500 mt-1'>{relationship.description}</p>}
      </div>
      <button
        onClick={onDelete}
  ...
  return (
    <div class='object-type-item bg-gray-50 p-3 rounded mb-2 border border-gray-200 flex justify-between items-center'>
      <div>
        ...
        {objectType.description && <p class='text-sm text-gray-500 mt-1'>{objectType.description}</p>}
      </div>
      <button
        onClick={onDelete}
        class='ml-4 bg-red-50 hover:bg-red-100 text-red-600 px-2 py-1 rounded text-sm'
        ...
        <div class='grid grid-cols-1 md:grid-cols-3 gap-4'>
          <button
            ...
            class={`p-4 rounded border hover:shadow-md transition ${
              selectedExample.value === 'rbac' ? 'bg-blue-50 border-blue-300' : 'bg-white border-gray-200'
            }`}
          >
          ...
          <button
            ...
            class={`p-4 rounded border hover:shadow-md transition ${
              selectedExample.value === 'documentAccess' ? 'bg-blue-50 border-blue-300' : 'bg-white border-gray-200'
            }`}
          >
          ...
          <button
            ...
            class={`p-4 rounded border hover:shadow-md transition ${
              selectedExample.value === 'tenantAccess' ? 'bg-blue-50 border-blue-300' : 'bg-white border-gray-200'
            }`}
          >
