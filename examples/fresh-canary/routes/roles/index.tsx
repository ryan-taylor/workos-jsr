...
const RolesPage: FunctionComponent<PageProps> = () => {
  return (
    <div class='p-4 mx-auto max-w-screen-lg'>
      <div class='mb-8'>
        <h1 class='text-2xl font-bold mb-4'>Role-Based Access Control (RBAC)</h1>

        <div class='bg-white p-6 rounded-lg shadow-sm mb-6'>
          <h2 class='text-xl font-semibold mb-2'>What is RBAC?</h2>
          <p class='mb-4'>
            Role-Based Access Control (RBAC) is a security approach that restricts system access to authorized users based on roles. Instead of
            assigning permissions directly to users, permissions are associated with roles, and users are assigned to appropriate roles.
          </p>
          ...
          <ul class='list-disc pl-6 mb-4 space-y-1'>
            ...
            <li>Enhanced security posture by following the principle of least privilege</li>
          </ul>
        ...
        <div class='bg-white p-6 rounded-lg shadow-sm mb-6'>
          ...
          <div class='grid grid-cols-1 md:grid-cols-2 gap-4 mb-4'>
            <div class='border border-gray-200 rounded p-4'>
              ...
              <p class='text-sm mb-2'>Full access to all resources and settings</p>
          ...
          <div class='text-sm text-gray-600 mb-2'>
            ...
            <ul class='list-disc pl-6 space-y-0.5'>
              <li>Follow the principle of least privilege - assign only the minimum permissions needed</li>
              <li>Use descriptive role names and consistent permission patterns</li>
              <li>Regularly audit role assignments and permissions</li>
              <li>Consider implementing custom roles for specialized use cases</li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div class='mt-8 text-sm text-gray-600 p-4 bg-gray-50 rounded'>
        ...
        <p>
          This demo showcases a UI implementation of WorkOS's Roles functionality with simulated data. In a production environment, you would connect
          this interface to your actual WorkOS instance to manage and assign roles for your organization's users.
        </p>
      </div>
    </div>
  );
