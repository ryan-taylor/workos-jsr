    ...
    <>
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="prose prose-lg max-w-none mb-12">
          <p>
            This demo showcases how to receive and process webhooks from WorkOS. Webhooks allow your application 
            to receive real-time updates when events occur in WorkOS, such as user creation, authentication events, 
            directory sync changes, and more.
          </p>
          
          <div class="bg-blue-50 border-l-4 border-blue-500 p-4 my-6">
            <h3 class="text-blue-800 font-semibold">What are WorkOS Webhooks?</h3>
            <p class="text-blue-700 mt-2">
              WorkOS uses webhooks to notify your application when events happen in your WorkOS account. 
              Instead of having to poll the WorkOS API, webhooks are pushed to your application in real-time, 
          ...
          <ol class="list-decimal pl-6 space-y-4">
            <li>
              ...
              <p>
                Log in to your WorkOS Dashboard and navigate to the "Webhooks" section. 
                Add the following URL as your webhook endpoint:
              </p>
            ...
            <li>
              ...
              <p>
                WorkOS will provide you with a webhook secret when you create a webhook endpoint. 
            ...
            <li>
              ...
              <p>
                For testing webhooks during development, you can use a service like ngrok to expose 
                your local server to the internet with a temporary URL.
              </p>
            </li>
          </ol>
          ...
          <p>
            It's crucial to verify that incoming webhooks are actually from WorkOS. WorkOS signs each 
            webhook with a signature using your webhook secret.
          </p>
    ...
    return new Response(
      ...
      { status: 400, headers: { "Content-Type": "application/json" } }
          ...
          <ul class="list-disc pl-6 space-y-2">
            <li><strong>Authentication Events:</strong> <code>authentication.succeeded</code>, <code>authentication.failed</code></li>
            <li><strong>User Management:</strong> <code>user.created</code>, <code>user.updated</code>, <code>user.deleted</code></li>
            <li><strong>Directory Sync:</strong> <code>dsync.user.created</code>, <code>dsync.group.updated</code>, etc.</li>
            <li><strong>Organizations:</strong> <code>organization.created</code>, <code>organization.updated</code></li>
            <li><strong>SSO:</strong> <code>connection.activated</code>, <code>connection.deactivated</code></li>
          </ul>
          
          <p class="mt-4">
            For a complete list of event types, refer to the <a href="https://workos.com/docs/webhooks/events" class="text-blue-600 hover:underline">WorkOS Webhooks documentation</a>.
          </p>
        </div>
        ...
        <div class="bg-white rounded-lg p-6 shadow-sm mb-8">
          <p class="mb-4">
            The viewer below displays webhook events received by your application. Configure a webhook in your WorkOS Dashboard 
            pointing to <code class="bg-gray-100 px-2 py-1 rounded">/api/webhooks/listener</code> to start receiving events.
          </p>
