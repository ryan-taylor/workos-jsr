...
import { generateWidgetToken, WidgetType, WidgetTheme } from "../../../utils/widgets.ts";
...
export const handler: Handlers = {
  async POST(req) {
    try {
      ...
      return new Response(
        JSON.stringify({ 
          error: error instanceof Error ? error.message : "An error occurred while generating the widget configuration" 
        }),
