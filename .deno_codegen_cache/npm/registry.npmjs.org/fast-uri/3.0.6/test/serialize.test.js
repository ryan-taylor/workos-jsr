...
test("URI Serialize", (t) => {
  ...
  t.equal(
    URI.serialize({ host: "10.10.10.10" }),
    "//10.10.10.10",
    "IPv4address",
  );
...
test("WS serialize", (t) => {
  ...
  t.equal(
    URI.serialize({ scheme: "ws", host: "example.com", resourceName: "/foo" }),
    "ws://example.com/foo",
  );
  t.equal(
    URI.serialize({
...
test("WSS serialize", (t) => {
  ...
  t.equal(
    URI.serialize({ scheme: "wss", host: "example.com", resourceName: "/foo" }),
    "wss://example.com/foo",
  );
  t.equal(
    URI.serialize({
