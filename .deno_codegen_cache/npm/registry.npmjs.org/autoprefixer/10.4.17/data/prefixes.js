...
// filter() function
let prefixFilterFunction = require(
...
// Backdrop-filter
let prefixBackdropFilter = require(
...
// element() function
let prefixElementFunction = require(
...
// Background options
let prefixBackgroundOptions = require(
...
let prefixBackgroundClipText = require(
...
let prefixPlaceholderShown = require(
...
let prefixBackdrop = require(
  "caniuse-lite/data/features/mdn-css-backdrop-pseudo-element",
);
...
let prefixFileSelectorButton = require(
  "caniuse-lite/data/features/css-file-selector-button",
);
...
// Zoom cursors
let prefixCursorsNewer = require(
...
let prefixDecorationShorthand = require(
  "caniuse-lite/data/features/mdn-text-decoration-shorthand",
);
...
let prefixDecorationColor = require(
  "caniuse-lite/data/features/mdn-text-decoration-color",
);
...
let prefixDecorationLine = require(
  "caniuse-lite/data/features/mdn-text-decoration-line",
);
...
let prefixDecorationStyle = require(
  "caniuse-lite/data/features/mdn-text-decoration-style",
);
...
// Text Size Adjust
let prefixTextSizeAdjust = require(
...
let prefixBoxdecoration = require(
...
// Viewport at-rule
let prefixDeviceadaptation = require(
...
// CSS text-align-last
let prefixTextAlignLast = require(
...
// Logical Properties
let prefixLogicalProps = require(
...
let bidiIsolate = require(
  "caniuse-lite/data/features/mdn-css-unicode-bidi-isolate",
);
...
let bidiPlaintext = require(
  "caniuse-lite/data/features/mdn-css-unicode-bidi-plaintext",
);
...
let bidiOverride = require(
  "caniuse-lite/data/features/mdn-css-unicode-bidi-isolate-override",
);
...
// text-orientation
let prefixTextOrientation = require(
...
// print-color-adjust
let prefixPrintAdjust = require(
  "caniuse-lite/data/features/css-print-color-adjust",
);
