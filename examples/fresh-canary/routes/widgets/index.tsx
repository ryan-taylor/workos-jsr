            ...
            <div class="bg-white shadow rounded-lg p-6">
              ...
              <div class="prose">
                ...
                <ul class="mt-4 space-y-2 list-disc list-inside">
                  <li><strong>Users Table</strong> - Display and manage users in your application</li>
                  <li><strong>Auth Flow</strong> - Complete authentication flow with SSO options</li>
                  <li><strong>Profile Editor</strong> - Let users update their profile information</li>
                  <li><strong>Org Switcher</strong> - Allow users to switch between organizations</li>
                </ul>
              </div>
            </div>
        ...
        <div class="bg-indigo-50 rounded-xl p-8 mb-12">
          <div class="max-w-3xl mx-auto text-center">
            ...
            <p class="text-indigo-600 mb-6">
              Use the configurator above to generate customized code snippets or check out the 
              complete documentation for more advanced integration options.
            </p>
