...
var parser = (function () {
  ...
  var parser = {
    ...
    describeSymbol: function parser_describeSymbol(symbol) {
      if (
        symbol !== this.EOF && this.terminal_descriptions_ &&
    ...
    collect_expected_token_set: function parser_collect_expected_token_set(
      ...
      if (
        !do_not_describe && this.state_descriptions_ &&
    ...
    parse: function parse(input) {
      ...
      var NO_ACTION = [
        0,
        47, /* === table.length :: ensures that anyone using this new state will fail dramatically! */
      ];
  ...
  var lexer = function () {
    ...
    var lexer = {
      ...
      parseError: function lexer_parseError(str, hash, ExceptionClass) {
        ...
        if (this.yy) {
          if (
            this.yy.parser && typeof this.yy.parser.parseError === "function"
          ) {
      ...
      deriveLocationInfo: function lexer_deriveYYLLOC(
        ...
        if (loc.first_line <= 0 || loc.last_line < loc.first_line) {
          ...
          if (
            (loc.last_line <= 0 || loc.last_line < loc.first_line) && following
          ) {
      ...
      prettyPrintRange: function lexer_prettyPrintRange(
        ...
        var rv = lines.slice(l0 - 1, l1 + 1).map(
        ...
        if (
          nonempty_line_indexes.length > 2 * MINIMUM_VISIBLE_NONEMPTY_LINE_COUNT
        ) {
          var clip_start =
            nonempty_line_indexes[MINIMUM_VISIBLE_NONEMPTY_LINE_COUNT - 1] + 1;
          var clip_end = nonempty_line_indexes[
      ...
      next: function lexer_next() {
        ...
        if (!spec) {
          ...
          if (!spec || !spec.rules) {
            ...
            var p = this.constructLexErrorInfo(
              "Internal lexer engine error" + lineno_msg +
        ...
        if (!this._input) {
          ...
          token = this.parseError(p.errStr, p, this.JisonLexerError) ||
            this.ERROR;
