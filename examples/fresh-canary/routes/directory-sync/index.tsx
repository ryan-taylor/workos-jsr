    ...
    <div class='p-4 mx-auto max-w-screen-lg'>
      ...
      <div class='mb-4'>
        <p class='text-gray-700'>
          This page demonstrates how to use WorkOS Directory Sync with Deno/Fresh. It shows a list of connected directories from your WorkOS account
          with real-time updates and interactive filtering.
        </p>
      </div>
        ...
        <div class='bg-gray-50 p-4 rounded-lg'>
          <ol class='list-decimal pl-5 space-y-2'>
            <li>
              ...
              <a href='https://dashboard.workos.com/directories' class='text-indigo-600 hover:underline' target='_blank'>WorkOS Dashboard</a>
            </li>
