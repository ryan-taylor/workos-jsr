...
import { type generatePortalLink, GeneratePortalLinkIntent, getIntentDisplayName, type PortalBrandingOptions } from '../utils/portal.ts';
      ...
      <div class='bg-white shadow rounded-lg p-6'>
        ...
        <div class='mb-4'>
          ...
          <select
            ...
            value={intent.value}
            onChange={(e) => {
              intent.value = (e.target as HTMLSelectElement).value as GeneratePortalLinkIntent;
            }}
            class='block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500'
          >
