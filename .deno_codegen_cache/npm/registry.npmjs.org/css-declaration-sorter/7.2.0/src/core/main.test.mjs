...
const keepOverridesTests = [
  ...
  },
  {
    ...
    fixture:
      "a{background: grey;border-width: 0;border-top-width: 1px;border-inline-start-width: 1px;}",
    expected:
      "a{background: grey;border-width: 0;border-inline-start-width: 1px;border-top-width: 1px;}",
    options: { keepOverrides: true },
  },
  {
  ...
  },
  {
    ...
    fixture:
      "a{border-radius: 5px;border-end-start-radius: 0;border-end-end-radius: 0;}",
    expected:
      "a{border-radius: 5px;border-end-end-radius: 0;border-end-start-radius: 0;}",
    options: { keepOverrides: true },
  },
];
