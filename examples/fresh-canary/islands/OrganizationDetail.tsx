      ...
      <div className='mb-6'>
        <nav className='flex space-x-4 border-b'>
          ...
          <button
            ...
            className={`px-3 py-2 font-medium text-sm ${
              activeTab === 'domains' ? 'border-b-2 border-blue-500 text-blue-600' : 'text-gray-500 hover:text-gray-700'
            }`}
          >
            Domains
          </button>
                ...
                <form onSubmit={handleUpdateOrganization}>
                  <div className='mb-4'>
                    ...
                    <input
                      type='text'
                      value={editForm.name || ''}
                      onChange={(e: JSX.TargetedEvent<HTMLInputElement>) => setEditForm({ ...editForm, name: (e.target as HTMLInputElement).value })}
                      required
                    ...
                    <form onSubmit={handleAddMetadata} className='grid grid-cols-1 md:grid-cols-3 gap-4 mb-4'>
                      <div>
                        <input
                          ...
                          onChange={(e: JSX.TargetedEvent<HTMLInputElement>) => setNewMetadataKey((e.target as HTMLInputElement).value)}
                          required
                          className='w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500'
                        />
                      </div>
                      <div>
                        <input
                          ...
                          onChange={(e: JSX.TargetedEvent<HTMLInputElement>) => setNewMetadataValue((e.target as HTMLInputElement).value)}
                          required
                          className='w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500'
                        />
                      </div>
        ...
        {activeTab === 'members' && (
          <div className='p-6'>
            <div className='mb-6 flex justify-end'>
              <button className='px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2'>
                Invite Member
              </button>
            </div>
