  ...
  return (
    <div class="container">
      ...
      <div class="description">
        <p>
          WorkOS Vault is a secure credential and secret management service that
          allows you to store and manage sensitive information. It provides a
          simple API for encrypting and decrypting data, with built-in key
          management.
        </p>
      </div>
      ...
      <div class="demo-section">
        ...
        <p>
          Try out the WorkOS Vault encryption and decryption functionality using
          the interactive demo below. Enter text to encrypt or decrypt and see
        ...
        <div class="use-case-grid">
          ...
          <div class="use-case">
            ...
            <p>
              ...
              with end-to-end encryption. Vault ensures that sensitive data is
          ...
          <div class="use-case">
            ...
            <p>
              Meet regulatory requirements for data protection like GDPR and
              HIPAA. Vault helps you implement security best practices and
