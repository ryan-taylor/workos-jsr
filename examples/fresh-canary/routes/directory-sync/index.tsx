...
import { initDirectorySync, listDirectories, Directory } from "../../utils/directory-sync.ts";
...
const DirectoriesPage: FunctionComponent<PageProps<DirectoriesPageData>> = ({ data }) => {
    ...
    <div class="p-4 mx-auto max-w-screen-lg">
      ...
      <div class="mb-4">
        <p class="text-gray-700">
          This page demonstrates how to use WorkOS Directory Sync with Deno/Fresh. 
          It shows a list of connected directories from your WorkOS account with
      ...
      <div class="mt-8">
        <h2 class="text-xl font-semibold mb-2">Getting Started with Directory Sync</h2>
        <div class="bg-gray-50 p-4 rounded-lg">
          <ol class="list-decimal pl-5 space-y-2">
            <li>Configure a directory connection in your <a href="https://dashboard.workos.com/directories" class="text-indigo-600 hover:underline" target="_blank">WorkOS Dashboard</a></li>
            <li>Use the Directory Sync module to fetch users and groups</li>
            <li>Set up webhooks to receive real-time updates when users or groups change</li>
          </ol>
        </div>
      </div>
    </div>
