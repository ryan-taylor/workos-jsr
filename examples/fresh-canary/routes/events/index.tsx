          ...
          <div class="bg-white shadow overflow-hidden sm:rounded-lg mb-6">
            ...
            <div class="border-t border-gray-200 px-4 py-5 sm:px-6">
              <div class="prose max-w-none">
                <p>
                  WorkOS Events provide a comprehensive audit trail of
                  activities in your application. Use this dashboard to monitor
                  events in real-time or search through historical events.
                </p>
                <h3>Features:</h3>
                <ul>
                ...
                <p>
                  Each event includes metadata that provides context about what
                  happened, who performed the action, when it occurred, and
