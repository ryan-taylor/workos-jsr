...
import { ComponentType, ComponentChildren, VNode, createContext, h } from "preact";
  ...
  function TelemetryWrappedComponent(props: P) {
    ...
    useLayoutEffect(() => {
      ...
      if (!hydrated.current) {
        ...
        const timeSincePageLoad = now - (window.performance?.timing?.domContentLoadedEventEnd || 0);
