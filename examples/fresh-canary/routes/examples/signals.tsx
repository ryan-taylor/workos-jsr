...
export default function SignalsPage({ data }: PageProps<{
  ...
  return (
    <div class="container">
      ...
      <p>
        This page demonstrates the use of Preact Signals for state management.
      </p>
      ...
      <div class="comparison-info">
        ...
        <ul>
          <li>
            ...
            Only components using a specific signal re-render when it changes
          </li>
          <li>
            <strong>Improved performance:</strong>{" "}
            Fewer re-renders means better performance in complex UIs
          </li>
          <li>
            <strong>Simpler code:</strong>{" "}
            Less boilerplate than useState, useCallback, and useMemo
          </li>
          <li>
            <strong>Automatic dependency tracking:</strong>{" "}
            No need to specify dependencies manually
          </li>
          <li>
            <strong>Easier debugging:</strong>{" "}
            Signals provide a clear data flow through your application
          </li>
        </ul>
      </div>
