...
Deno.test("fresh-middleware-adapter", async (t) => {
  await t.step("ensureContextState should add state property if missing", () => {
  ...
  await t.step("adaptMiddleware should return object with handler for Fresh 2.x", () => {
    // Mock Fresh 2.x
  ...
  await t.step("createCompatibleMiddleware should return fresh 1.x compatible middleware", async () => {
    // Mock Fresh 1.x
    const restore = mockFreshVersion(false);
  ...
  await t.step("createCompatibleMiddleware should return fresh 2.x compatible middleware", async () => {
    // Mock Fresh 2.x
    const restore = mockFreshVersion(true);
