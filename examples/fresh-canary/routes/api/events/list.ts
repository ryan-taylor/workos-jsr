...
import type { EventName } from '../../../../../src/common/interfaces/event.interface.ts';
...
export const handler: Handlers = {
  async GET(req, _ctx) {
    ...
    try {
      ...
      const events = url.searchParams.get('events') ? url.searchParams.get('events')!.split(',') as EventName[] : [];
