  ...
  async GET(req, ctx) {
    ...
    if (code && userId) {
      try {
        ...
        return ctx.render({ 
          error: "Failed to verify email. The verification code may be invalid or expired." 
        });
      }
    }
  ...
  return (
    <div class="container">
      ...
      {sent ? (
        ...
        <>
          <p>Verify your email address to ensure you can recover your account and receive important notifications.</p>
