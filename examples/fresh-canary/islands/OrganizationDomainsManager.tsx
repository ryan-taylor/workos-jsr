...
export default function OrganizationDomainsManager() {
  ...
  async function fetchDomains() {
    setIsLoading(true);
    try {
      const url = selectedOrgId ? `/api/organization-domains/list?organization_id=${selectedOrgId}` : '/api/organization-domains/list';
  ...
  const filteredDomains = domains.filter((domain) => domain.domain.toLowerCase().includes(searchQuery.toLowerCase()));
