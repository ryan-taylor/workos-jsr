        ...
        <div class='bg-white shadow rounded-lg overflow-hidden mb-8'>
          <div class='px-6 py-8'>
            ...
            <p class='text-gray-600 mb-4'>
              The WorkOS Admin Portal allows your customers to provide their end users with a branded, self-service portal for managing various
              aspects of their account - without you having to build custom UI components. Your customers can manage their SSO, Directory Sync, audit
              logs, and more all within a consistent interface.
            </p>
          ...
          <div class='px-6 py-8'>
            ...
            <div class='space-y-6'>
              <div>
                ...
                <p class='text-gray-600'>
                  Allow organization administrators to manage their users - add new users, remove access for departing team members, or adjust
              ...
              <div>
                ...
                <p class='text-gray-600'>
                  Provide a simple interface for your customers to set up and manage their Single Sign-On connections, eliminating the need for your
                  engineering team to handle these requests.
                </p>
              </div>
              ...
              <div>
                ...
                <p class='text-gray-600'>
                  Enable your customers to manage their directory connections, view sync status, and troubleshoot integration issues directly.
                </p>
              </div>
              ...
              <div>
                ...
                <p class='text-gray-600'>
                  Give your customers visibility into authentication events, user activities, and administrative changes to meet compliance
                  requirements.
                </p>
              </div>
            </div>
        ...
        <div class='bg-white shadow rounded-lg overflow-hidden mb-8'>
          <div class='px-6 py-8'>
            ...
            <p class='text-gray-600 mb-6'>
              Use the form below to generate an Admin Portal link with your preferred configuration. You can then embed the portal directly in your
              application or redirect users to it.
            </p>
