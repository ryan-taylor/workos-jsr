  ...
  return (
    <div class="container mx-auto px-4 py-8">
      ...
      <p class="text-lg text-gray-700 mb-6">
        This demo showcases how WorkOS's Actions approval flow enables applications to implement 
        approval-based workflows securely and efficiently.
      </p>
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
        <div class="bg-white rounded-lg shadow-md p-6">
          ...
          <p class="text-gray-600">
            Implement secure access request workflows where users can request access to
            resources and administrators can approve or deny these requests.
          </p>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
          ...
          <p class="text-gray-600">
            ...
            before being implemented, reducing the risk of accidental or malicious changes.
          </p>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
          ...
          <p class="text-gray-600">
            Add an extra layer of security for sensitive operations like bulk data
            deletions, financial transactions, or system-wide changes.
          </p>
        </div>
      </div>
