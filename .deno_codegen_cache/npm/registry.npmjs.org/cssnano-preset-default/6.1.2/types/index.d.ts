...
declare namespace defaultPreset {
  export { AutoprefixerOptions, BrowserslistOptions, Options, SimpleOptions };
}
type Options = {
  cssDeclarationSorter?:
    | SimpleOptions<
      {
        order?:
          | ("alphabetical" | "concentric-css" | "smacss")
          | ((propertyNameA: string, propertyNameB: string) => 0 | 1 | -1)
          | undefined;
...
type BrowserslistOptions = Pick<
  import("browserslist").Options,
  "stats" | "path" | "env"
>;
type SimpleOptions<OptionsExtends extends void | object = void> =
  | false
  | (OptionsExtends & {
    exclude?: true;
  });
