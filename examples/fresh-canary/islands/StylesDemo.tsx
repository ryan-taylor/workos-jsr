    ...
    <div style={containerStyle} className="styles-demo">
      ...
      <section className="demo-section">
        ...
        <p className="explanation">
          This component uses scoped styling that doesn't affect other parts of the application.
          Each section has its own styles that are applied only to elements within this component.
        </p>
      ...
      <section className="demo-section">
        ...
        <p className="explanation">
          The styling is consistent between server-side rendering and client-side hydration.
          There are no style flashes or layout shifts when the component hydrates.
        </p>
      ...
      <section className="demo-section">
        ...
        <p className="explanation">
          This demonstrates dynamic styling that changes based on component state.
          Try clicking the buttons below to see how the styling updates.
        </p>
