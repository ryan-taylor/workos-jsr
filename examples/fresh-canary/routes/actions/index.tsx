  ...
  return (
    <div class="container mx-auto px-4 py-8">
      ...
      <p class="text-lg text-gray-700 mb-6">
        This demo showcases how WorkOS's Actions approval flow enables
        applications to implement approval-based workflows securely and
        efficiently.
      </p>
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
        <div class="bg-white rounded-lg shadow-md p-6">
          ...
          <p class="text-gray-600">
            Implement secure access request workflows where users can request
            access to resources and administrators can approve or deny these
            requests.
          </p>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
          ...
          <p class="text-gray-600">
            Ensure critical configuration changes go through an approval process
            before being implemented, reducing the risk of accidental or
            malicious changes.
          </p>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
          ...
          <p class="text-gray-600">
            Add an extra layer of security for sensitive operations like bulk
            data deletions, financial transactions, or system-wide changes.
          </p>
        </div>
      </div>
      ...
      <div class="bg-gray-50 p-6 rounded-lg shadow mb-12">
        ...
        <ol class="list-decimal list-inside space-y-3 text-gray-700">
          <li>
            An action is initiated (e.g., a user requests access or a
            configuration change)
          </li>
          <li>The action is captured and stored with a "pending" status</li>
          <li>Approvers are notified of the pending action</li>
          <li>
            Approvers review the action and make a decision (approve or reject)
          </li>
          <li>The action's status is updated based on the decision</li>
          <li>
            The system executes the appropriate response (e.g., granting access
            or making the configuration change)
          </li>
        </ol>
      </div>
