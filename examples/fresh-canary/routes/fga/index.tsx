    ...
    <div class="p-4 mx-auto max-w-7xl">
      <div class="mb-8">
        ...
        <div class="bg-blue-50 border-l-4 border-blue-500 p-4 mb-6">
          <p class="text-blue-700">
            This page demonstrates the capabilities of WorkOS FGA, allowing you
            to create authorization models and test permission checks in
            real-time.
          </p>
        </div>
      </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
          <div class="bg-white p-5 rounded-lg shadow">
            ...
            <p class="text-gray-600">
              Fine-Grained Authorization (FGA) is a sophisticated permission
              system that allows you to define relationships between objects and
              users with precise control over who can access what.
            </p>
          </div>
          <div class="bg-white p-5 rounded-lg shadow">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div class="bg-white p-5 rounded-lg border border-gray-200">
            ...
            <div class="bg-gray-50 p-3 rounded text-sm font-mono">
              user:alice <span class="text-blue-500">is member of</span>{" "}
              role:admin<br />
              role:admin <span class="text-blue-500">has permission</span>{" "}
          ...
          <div class="bg-white p-5 rounded-lg border border-gray-200">
            ...
            <div class="bg-gray-50 p-3 rounded text-sm font-mono">
              user:bob <span class="text-blue-500">is editor of</span>{" "}
              document:report<br />
              user:charlie <span class="text-blue-500">is viewer of</span>{" "}
              document:report
            </div>
          </div>
          <div class="bg-white p-5 rounded-lg border border-gray-200">
            ...
            <div class="bg-gray-50 p-3 rounded text-sm font-mono">
              user:david <span class="text-blue-500">is member of</span>{" "}
              tenant:company-a<br />
              tenant:company-a <span class="text-blue-500">has access to</span>
              {" "}
              feature:analytics
            </div>
          </div>
          <div class="bg-white p-5 rounded-lg border border-gray-200">
            ...
            <div class="bg-gray-50 p-3 rounded text-sm font-mono">
              user:emma <span class="text-blue-500">is owner of</span>{" "}
              folder:reports<br />
              folder:reports <span class="text-blue-500">contains</span>{" "}
              document:q1-report
            </div>
          </div>
        </div>
      ...
      <div class="mb-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
          <a
            href="https://workos.com/docs/fga"
            class="block bg-white p-5 rounded-lg border border-gray-200 hover:border-blue-300 hover:shadow-md transition"
          >
            <h3 class="text-lg font-medium mb-2 text-blue-600">
              WorkOS FGA Documentation
            </h3>
            <p class="text-gray-600">
              Complete guides and API reference for implementing FGA in your
              applications.
            </p>
          </a>
          <a
            href="https://workos.com/blog/tags/authorization"
            class="block bg-white p-5 rounded-lg border border-gray-200 hover:border-blue-300 hover:shadow-md transition"
          >
            <h3 class="text-lg font-medium mb-2 text-blue-600">
              Authorization Blog Posts
            </h3>
            <p class="text-gray-600">
              Articles, tutorials, and best practices for implementing robust
              authorization.
            </p>
          </a>
          <a
            href="https://github.com/workos/workos-node"
            class="block bg-white p-5 rounded-lg border border-gray-200 hover:border-blue-300 hover:shadow-md transition"
          >
            <h3 class="text-lg font-medium mb-2 text-blue-600">WorkOS SDK</h3>
            <p class="text-gray-600">
              Open-source SDKs for integrating WorkOS with Node.js, Python,
              Ruby, and more.
            </p>
          </a>
        </div>
