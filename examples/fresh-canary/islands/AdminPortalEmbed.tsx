...
import {
  type generatePortalLink,
  GeneratePortalLinkIntent,
  getIntentDisplayName,
  type PortalBrandingOptions,
...
const AdminPortalEmbed: FunctionComponent<AdminPortalEmbedProps> = (
  { initialOrganizationId = "" },
) => {
  // Portal configuration state using signals
  const organizationId = useSignal(initialOrganizationId);
  const intent = useSignal<GeneratePortalLinkIntent>(
      ...
      <div class="bg-white shadow rounded-lg p-6">
        ...
        <div class="mb-4">
          ...
          <input
            ...
            onInput={(e) => {
              organizationId.value = (e.target as HTMLInputElement).value;
            }}
            placeholder="org_..."
        ...
        <div class="mb-4">
          ...
          <select
            ...
            value={intent.value}
            onChange={(e) => {
              intent.value = (e.target as HTMLSelectElement)
                .value as GeneratePortalLinkIntent;
            }}
            class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
          >
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
          <div>
            ...
            <input
              ...
              onInput={(e) => {
                returnUrl.value = (e.target as HTMLInputElement).value;
              }}
          ...
          <div>
            ...
            <input
              ...
              onInput={(e) => {
                successUrl.value = (e.target as HTMLInputElement).value;
              }}
        ...
        <div class="mb-4">
          <div class="flex items-center mb-2">
            <input
              ...
              onChange={() => {
                customBranding.value = !customBranding.value;
              }}
            ...
            <div class="pl-6 space-y-3 mt-2 p-3 bg-gray-50 rounded-md">
              <div>
                ...
                <input
                  ...
                  value={logo.value}
                  onInput={(e) => {
                    logo.value = (e.target as HTMLInputElement).value;
                  }}
              ...
              <div>
                ...
                <input
                  ...
                  onInput={(e) => {
                    headerText.value = (e.target as HTMLInputElement).value;
                  }}
