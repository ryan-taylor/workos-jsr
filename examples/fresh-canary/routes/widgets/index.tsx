      ...
      <div class="max-w-screen-xl mx-auto px-4 py-8">
        <div class="mb-10">
          ...
          <p class="text-lg text-gray-600 max-w-3xl">
            Embed WorkOS pre-built UI components directly into your application,
            saving development time and providing a consistent experience.
          </p>
        </div>
          ...
          <div class="space-y-6">
            <div class="bg-white shadow rounded-lg p-6">
              <h2 class="text-xl font-semibold text-gray-900 mb-4">
                About WorkOS Widgets
              </h2>
              <div class="prose">
                <p>
                  WorkOS Widgets are pre-built UI components that provide
                  ready-made interfaces for common functionality:
                </p>
                <ul class="mt-4 space-y-2 list-disc list-inside">
                  <li>
                    <strong>Users Table</strong>{" "}
                    - Display and manage users in your application
                  </li>
                  <li>
                    <strong>Auth Flow</strong>{" "}
                    - Complete authentication flow with SSO options
                  </li>
                  <li>
            ...
            <div class="bg-white shadow rounded-lg p-6">
              ...
              <p class="mt-4 text-sm text-gray-500">
                See the demonstration and code samples on the left for detailed
        ...
        <div class="bg-indigo-50 rounded-xl p-8 mb-12">
          <div class="max-w-3xl mx-auto text-center">
            <h2 class="text-2xl font-bold text-indigo-700 mb-4">
              Ready to add WorkOS Widgets to your app?
            </h2>
            <p class="text-indigo-600 mb-6">
              Use the configurator above to generate customized code snippets or
              check out the complete documentation for more advanced integration
              options.
            </p>
