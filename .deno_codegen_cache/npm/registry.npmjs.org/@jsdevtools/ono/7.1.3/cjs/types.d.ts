...
export interface OnoConstructor {
  <T extends ErrorLike>(
    constructor: ErrorLikeConstructor<T>,
    options?: OnoOptions,
  ): Ono<T>;
  new <T extends ErrorLike>(
    constructor: ErrorLikeConstructor<T>,
    options?: OnoOptions,
  ): Ono<T>;
  /**
   ...
   */
  extend<T extends ErrorLike, P extends object>(
    error: T,
    props?: P,
  ): T & P & OnoError<T & P>;
  /**
   ...
   */
  extend<T extends ErrorLike, E extends ErrorLike>(
    error: T,
    originalError?: E,
  ): T & E & OnoError<T & E>;
  /**
   ...
   * @param props - An object whose properties will be added to the error
   */
  extend<T extends ErrorLike, E extends ErrorLike, P extends object>(
    error: T,
    originalError?: E,
    props?: P,
...
export interface Ono<T extends ErrorLike> {
   ...
   */
  <E extends ErrorLike, P extends object>(
    error: E,
    props: P,
  ): T & E & P & OnoError<T & E & P>;
  /**
 ...
 */
export declare type ErrorLikeConstructor<T extends ErrorLike> =
  | ErrorLikeConstructorFunction<T>
  | ErrorLikeConstructorClass<T>;
/**
 ...
 */
export declare type MessageFormatter = (
  message: string,
  ...args: unknown[]
) => string;
